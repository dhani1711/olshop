  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?=base_url('index.php/barang/dashboard')?>" class="logo"><b>Togamedia</b></a>
            <!--logo end-->
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li>
                    <a class="logout" href="<?=base_url('index.php/Login/logout')?>" onclick="return confirm('Logout Akun ?')">
                    Logout
                    </a>
                    </li>
            	</ul>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a  href="<?=base_url('index.php/Dashboard')?>" class="active">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="active" href="<?=base_url('index.php/barang')?>">Daftar Barang</a></li>
                          <li><a class="active" href="<?=base_url('index.php/kategori')?>">Kategori</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
